 ...
 *
 * Accepts a ref so WalksScreen can call .toDataURL() to snapshot it as a
 * fixed-size bitmap for the map Marker's `image` prop (guarantees the icon
 * never scales with map zoom).
 */
const DogParkIcon = forwardRef<Svg, { size?: number }>(({ size = 22 }, ref) => (
  <Svg ref={ref} width={size} height={size} viewBox="0 0 24 24">
    {/* Left floppy ear */}
    <Ellipse cx={6.2} cy={10.5} rx={3.2} ry={4.8} fill="#8B6914" transform="rotate(-15, 6.2, 10.5)" />
    {/* Right floppy ear */}
    <Ellipse cx={17.8} cy={10.5} rx={3.2} ry={4.8} fill="#8B6914" transform="rotate(15, 17.8, 10.5)" />
    {/* Head */}
    ...
    {/* Mouth */}
    <Path d="M10.5 15.2 Q12 16.4 13.5 15.2" stroke="#2C1A0E" strokeWidth={0.7} fill="none" strokeLinecap="round" />
    {/* Tongue */}
    <Ellipse cx={12} cy={16.1} rx={1.0} ry={0.75} fill="#E05C7A" />
  </Svg>
));

export default DogParkIcon;
