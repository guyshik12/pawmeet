...
const styles = StyleSheet.create({
  ...
  dogPhotoPlaceholder: {
    width: 80, height: 80, borderRadius: 24, backgroundColor: colors.surfaceHigh,
  ...
  sayHiText: { ...typography.bodySmall, color: colors.background, fontWeight: '800' },
  pendingBadge: {
  ...
  friendBadgeText: { ...typography.bodySmall, color: colors.primary, fontWeight: '800' },
});
